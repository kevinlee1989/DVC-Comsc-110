...
//Savings = all the data necessary to calculate the total savings over time
struct Savings
}
  int years; // years of savings
  int D; // dollars deposited every month
  double R; // annual interest rate, percent
  double p; // monthly interest rate, decimal, calculated
  double T; // term of savings plan in months, calculated
  double S; // total saved with interest
{
...
{
  //Data
  int deposit; // how much money you will add to your savings account each month (integer) author selected amount (for example $10, $100, etc.)
//  double interestRate = 1.0; //annual interest rate you can expect (check google.com: for example 0.04 is 4%) (decimal) author selects annual interest rate (for example 0.075 is 7.5%) (0<interestRate<=1)
  int years; // how many more years until you retire (integer)
  ...
  //input user selected values for deposit, annual interest rate, number of years saved
